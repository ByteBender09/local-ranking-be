...
> = [
  ...
  },
  {
    ...
    nameEn: 'Ca Mau',
    region: 'south',
    coverImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1600&auto=format&fit=crop&q=80',
    tagline: 'Mũi đất tận cùng',
    description:
      'Vùng đất cuối cùng của Tổ Quốc — rừng đước, sông nước miệt vườn và đặc sản cua biển.',
    highlights: ['Mũi Cà Mau', 'Rừng U Minh', 'Cua Cà Mau', 'Chợ nổi'],
    lat: 9.1769,
    lng: 105.1524,
  },
  {
    ...
    nameEn: 'Hai Phong',
    region: 'north',
    coverImage: 'https://images.unsplash.com/photo-1473116763249-2faaef81ccda?w=1600&auto=format&fit=crop&q=80',
    tagline: 'Hoa phượng đỏ',
    description:
      'Thành phố cảng nổi tiếng với bánh đa cua, nem cua bể và những con phố hoa phượng.',
    highlights: ['Bánh đa cua', 'Phố Cát Dài', 'Đảo Cát Bà', 'Nem cua bể'],
    lat: 20.8449,
    lng: 106.6881,
  },
];
